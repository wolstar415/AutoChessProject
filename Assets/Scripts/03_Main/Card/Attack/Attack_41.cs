...
namespace GameS
{
    public class Attack_41 : AttackFunc
    {
        ...
        void AttackFunc()
        {
            ...
            info.pv.RPC(nameof(CreateBullet),RpcTarget.All,PlayerInfo.Inst.PlayerIdx,"Bullet_Feather",Target.GetComponent<PhotonView>().ViewID,CreatePos.position,Quaternion.identity,da);
