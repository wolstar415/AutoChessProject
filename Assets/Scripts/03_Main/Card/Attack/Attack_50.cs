...
namespace GameS
{
    public class Attack_50 : AttackFunc
    {
        ...
        void AttackFunc()
        {
            ...
            info.pv.RPC(nameof(CreateBullet),RpcTarget.All,PlayerInfo.Inst.PlayerIdx,"Bullet_Light2",Target.GetComponent<PhotonView>().ViewID,CreatePos.position,Quaternion.identity,da);
