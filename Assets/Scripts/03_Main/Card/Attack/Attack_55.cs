...
namespace GameS
{
    public class Attack_55 : AttackFunc
    {
        ...
        void AttackFunc()
        {
            ...
            info.pv.RPC(nameof(CreateBullet),RpcTarget.All,PlayerInfo.Inst.PlayerIdx,"Bullet_Bullet_2",Target.GetComponent<PhotonView>().ViewID,CreatePos.position,Quaternion.identity,da);
