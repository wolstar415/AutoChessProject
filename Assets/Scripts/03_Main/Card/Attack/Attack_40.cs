...
namespace GameS
{
    public class Attack_40 : AttackFunc
    {
        ...
        void AttackFunc()
        {
            ...
            if (skill)
            {
                ...
                info.pv.RPC(nameof(CreateBullet2),RpcTarget.All,PlayerInfo.Inst.PlayerIdx,"Bullet_Skill_40",CreatePos.position,Quaternion.identity,da,Target.transform.position,info.EnemyTeamIdx,false);
