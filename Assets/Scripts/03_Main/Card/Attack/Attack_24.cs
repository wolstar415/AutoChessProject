...
namespace GameS
{
    public class Attack_24 : AttackFunc
    {
        ...
        IEnumerator IAttackFunc()
        {
            ...
            if (skill)
            {
                    ...
                    info.pv.RPC(nameof(CreateBullet2),RpcTarget.All,PlayerInfo.Inst.PlayerIdx,"Bullet_Skill_24",CreatePos.position,Quaternion.identity,da,Target.transform.position,info.EnemyTeamIdx,false);
